...
change = int(input("\nWhich type of conversion you want to do from 1 to 8: "))
...
if change == 1:
    ...
    if length_convert == 1:
        ...
        print("{} centimeter is equal to {} feet".format(length_value, length_value * 0.0328084))
    elif length_convert == 12:
        print("{} feet is equal to {} inch".format(length_value, length_value * 12))
    else:
        print("Sorry, Please type correct number from 1 to 13.")
elif change == 2:
    ...
    area_dict = {
        1: "Sqft to Sqmtrs",
        2: "Sqft to Hectre / Acres",
    }

    print("==========================")
    area_value = float(input("- Enter a number to convert: "))
    for keys, values in area_dict.items():
        print("{:2}. {}".format(keys, values))
    area_convert = int(input("\nWhich conversion you want to do from 1 to 2: "))
    if area_convert == 1:
        print("{} sqft is equal to {} sqmtr".format(area_value, area_value * 0.09290304))
    elif area_convert == 2:
        print("{} sqft is equal to {} hectre".format(area_value, area_value * 0.0000092903))
else:
